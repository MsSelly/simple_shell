...
/* gets 1 if using system getline() */
 ...
 * @next: this the points to the next node
 */
...
/**
 * struct passinfo - this only contains pseudo-arguements to pass into a function,
...
/* this my_shell_loop.c */
int my_hsh(info_t *, char **);
int find_my_builtin(info_t *);
void find_my_cmd(info_t *);
void fork_my_cmd(info_t *);

/* this my_parser.c */
int is_my_cmd(info_t *, char *);
char *my_dup_chars(char *, int, int);
char *finding_my_path(info_t *, char *, char *);
...
/* this is my_errors.c */
void my_eputs(char *);
int this_my_eputchar(char);
int calling_putfd(char c, int fd);
int calling_putsfd(char *str, int fd);

/* this is my_string.c */
int my_strlen(char *);
int this_my_strcmp(char *, char *);
char *where_starts_with(const char *, const char *);
char *this_my_strcat(char *, char *);

/* this is my_string1.c */
char *this_my_strcpy(char *, char *);
char *this_my_strdup(const char *);
void this_my_puts(char *);
int this_my_putchar(char);
...
/* this is my_tokenizer.c */
char **strtow(char *, char *);
char **strtow2(char *, char);

/* this is my_realloc.c */
...
/* this is my_builtin.c */
int _myexit(info_t *);
int _mycd(info_t *);
int _myhelp(info_t *);

/* this is my_builtin1.c */
int _myhistory(info_t *);
int _myalias(info_t *);

/*this is my_getline.c */
ssize_t get_input(info_t *);
int _getline(info_t *, char **, size_t *);
void sigintHandler(int);

/* thsi is my_getinfo.c */
void clear_info(info_t *);
void set_info(info_t *, char **);
void free_info(info_t *, int);

/* this is my_environ.c */
